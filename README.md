...
# Netra Help - Wireshark Lua Plugin

This is a custom Wireshark Lua Pluigin that integrates Wireshark with the Netra Web Platform. The plugin adds a new menu option inside Wireshark that redirects users to the Netra website.
